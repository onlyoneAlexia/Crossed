...
export function createAuthMiddleware({
  secret = process.env.RELAYER_API_TOKEN ?? process.env.API_SHARED_SECRET,
  service = "relayer",
} = {}) {
  if (!secret) {
    console.warn(`[security] ${service} API auth is disabled; set RELAYER_API_TOKEN or API_SHARED_SECRET`);
  }
  return (req, res, next) => {
